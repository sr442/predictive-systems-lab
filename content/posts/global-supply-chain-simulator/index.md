...
![Node Risk Assessment](risk_by_port.png?v=fresh)<br><br>
...
![Timeline Analysis](delay_timeline.png?v=fresh)<br><br>
...
![Macro Friction Analysis](macro_scatter.png?v=fresh)<br><br>
...
![SHAP Importance](shap_summary.png?v=fresh)
